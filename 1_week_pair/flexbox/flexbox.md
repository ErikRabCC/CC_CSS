...
![Flexbox main axis and cross-axis](https://static.journey.study/media/flexbox_demonstration_1.png)
...
![`justify-content`: `center`](https://static.journey.study/media/flexbox_jc_center.png)
...
![`justify-content`: `flex-start`](https://static.journey.study/media/flexbox_jc_flex_start.png)
...
![`justify-content`: `flex-end`](https://static.journey.study/media/flexbox_jc_flex_end.png)
...
![`justify-content`: `space-between`](https://static.journey.study/media/flexbox_jc_flex_space_between.png)

- `justify-content`: `space-around` Your items are evenly distributed along the **main-axis** with equal space around them.
![`justify-content`: `space-around`](https://static.journey.study/media/flexbox_jc_flex_space_around.png)
...
![`justify-content`: `space-evenly`](https://static.journey.study/media/flexbox_jc_flex_space_evenly.png)
...
- `align-items`: `center` 
![`align-items`: `center` ](https://static.journey.study/media/flexbox_ai_center.png)

- `align-items`: `flex-start` 
![`align-items`: `flex-start`](https://static.journey.study/media/flexbox_ai_flex_start.png)

- `align-items`: `flex-end` 
![`align-items`: `flex-end`](https://static.journey.study/media/flexbox_ai_flex_end.png)
...
![`flex-wrap`: `nowrap`](https://static.journey.study/media/flexbox_fw_nowrap.png)
...
![`flex-wrap`: `wrap`](https://static.journey.study/media/flexbox_fw_wrap.png)

- `flex-wrap`: ``wrap-reverse` The same as last time, but the order has been reversed.

![`flex-wrap`: ``wrap-reverse`](https://static.journey.study/media/flexbox_fw_wrap_reverse.png)
...
```
![`flex-wrap`: ``wrap-reverse`](https://static.journey.study/media/flexbox_fw_wrap.png)
...
![`flex-wrap`: ``wrap-reverse`](https://static.journey.study/media/flexbox_gap_1.png)
